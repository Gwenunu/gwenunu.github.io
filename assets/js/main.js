...
(function ($) {
  ...
  // Initialiser tous les onglets existants au chargement
  $(window).on("load", function () {
    $(".tabs").each(function () {
      initTabs(this);
    });
  ...
  $window.on("load", function () {
    ...
    $(document).on("click", ".popup-trigger", function (e) {
      ...
      if (content) {
        ...
        // Initialiser les onglets à l'intérieur du contenu de la pop-up
        popup.content.find(".tabs").each(function () {
          initTabs(this);
        });
      }
    });
